...
const dataService = {
    // Projects
    async getProjects () {
        const projects = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["prisma"].project.findMany({
            orderBy: {
                createdAt: "desc"
            }
        });
    ...
    async getProjectById (id) {
        const project = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["prisma"].project.findUnique({
            where: {
                id
            }
        });
    ...
    async getSkillCategories () {
        return await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["prisma"].skillCategory.findMany({
            orderBy: {
                displayOrder: "asc"
            }
        });
    ...
    async getSkillsByCategory (categoryId) {
        return await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["prisma"].skill.findMany({
            where: {
                categoryId
            },
            orderBy: {
    ...
    async getAllSkillsWithCategories () {
        const categories = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["prisma"].skillCategory.findMany({
            include: {
                skills: {
                    orderBy: {
                        displayOrder: "asc"
    ...
    async getTools () {
        const tools = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["prisma"].tool.findMany({
            orderBy: {
                order: "asc"
            }
        });
    ...
    // Experience
    async getExperience () {
        const experiences = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["prisma"].experience.findMany({
            orderBy: {
                displayOrder: "asc"
            }
        });
    ...
    // Education
    async getEducation () {
        const education = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["prisma"].education.findMany({
            orderBy: {
                displayOrder: "asc"
            }
        });
    ...
    async getCertifications () {
        const certifications = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["prisma"].certification.findMany({
            orderBy: {
                displayOrder: "asc"
            }
        });
...
function AboutSection(param) {
    ...
    const formatPeriod = (startDate, endDate, isCurrent)=>{
        ...
        const startFormatted = "".concat(String(start.getMonth() + 1).padStart(2, "0"), "/").concat(start.getFullYear());
        if (isCurrent || !endDate) {
            return "".concat(startFormatted, " - Present");
        }
        const end = parseDate(endDate);
        const endFormatted = "".concat(String(end.getMonth() + 1).padStart(2, "0"), "/").concat(end.getFullYear());
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        approvedFeedbacks.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=_6c5a840f._.js.map